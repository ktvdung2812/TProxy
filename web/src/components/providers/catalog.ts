...
const CATALOG: Record<string, ProviderTypeInfo> = {
  ...
  "grok-web": {
    ...
    listSection: "apikey",
    color: "#1DA1F2",
    description: "Grok.com subscription via SSO cookie (sso=…). Not the Grok Build OAuth CLI path.",
  ...
  "perplexity-web": {
    ...
    listSection: "apikey",
    color: "#20808D",
    description: "Perplexity.ai Pro/Max via session cookie (__Secure-next-auth.session-token).",
    website: "https://www.perplexity.ai",
    defaultAuthType: "api_key",
    supportsOAuth: false,
    defaultBaseUrl: "https://www.perplexity.ai/rest/sse/perplexity_ask",
  },
  antigravity: {
    type: "antigravity",
  ...
  cline: {
    ...
    color: "#5B9BD5",
    description:
      "Cline account models (Claude/GPT/Gemini via cline.bot). OAuth or API key from app.cline.bot. OAuth tokens use WorkOS workos: prefix.",
  ...
  clinepass: {
    ...
    color: "#5B9BD5",
    description:
      "ClinePass subscription models (cline-pass/*). Same OAuth as Cline; model discovery uses /v1/models filtered to cline-pass/.",
    website: "https://cline.bot",
    apiKeyUrl: "https://app.cline.bot",
    defaultAuthType: "oauth",
    supportsOAuth: true,
