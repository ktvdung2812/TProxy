...
func (b *Builder) Build() (*Service, error) {
	...
	modelsRegistry := pricing.NewModelsRegistry(pricing.ModelsRegistryOptions{CachePath: pricing.DefaultModelsRegistryCachePath(cfg.Database.DSN)})
	modelsRegistry.Start(context.Background(), time.Hour)
